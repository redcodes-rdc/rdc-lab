const generatorContent = {
  leftView: {
    ...
    description:
      "Build responsive accordion HTML/CSS/JS for FAQs, product details, policies, and guides. Customize layout, icons, styles, and behavior, then refine accessibility or Shopify Liquid with AI prompts.",
    callouts: [
      {
    ...
    useCases: [
      "Display FAQs with organized, expandable answers",
      "Show step-by-step guides without overwhelming the page",
      "Organize shipping, returns, care, and product details",
      "Make long support or policy content easier to scan",
      "Create product feature and specification breakdowns",
      "Add collapsible content blocks to landing pages",
    ],
    useCta: {
...
`,
      text: "Organize large amounts of content into a cleaner, easier-to-browse layout.",
    },
    output: {
      element: "pre",
      codeId: "accOutput",
      code: `<div class="rlab-acc-main rlab-acc-style1 rlab-acc-icon-plusminus">
  <div class="rlab-acc-inner">
    <div class="rlab-acc-col-wrap rdc-d-flex">
      <div class="rlab-acc-col rdc-w-full"></div>
    </div>
  </div>
</div>`,
    },
  ...
  settings: {
        ...
        fields: [
          {
            ...
            options: [
              { value: "single", label: "Single Column", selected: true },
        ...
        fields: [
          {
            ...
            id: "acc-stack-tab",
            className: "acc-stack-tab",
          },
          {
            type: "select",
            label: "Left Column",
            id: "acc-left-width-tab",
            className: "acc-left-width-tab",
            options: [
          ...
          },
          {
            type: "select",
            label: "Right Column",
            id: "acc-right-width-tab",
            className: "acc-right-width-tab",
            options: [
              { value: "", label: "Inherit Desktop" },
              { value: "rdc-t-w-20", label: "20%" },
              { value: "rdc-t-w-25", label: "25%" },
        ...
        fields: [
          {
            ...
            label: "Enable Image",
            id: "acc-enable-image",
            className: "acc-enable-image",
          },
          {
            type: "select",
            label: "Image Position",
            id: "acc-image-position",
            className: "acc-image-position",
            options: [
        ...
        fields: [
          {
            ...
            id: "acc-open-first",
            className: "acc-open-first",
          },
          {
            type: "checkbox",
            label: "Close Others On Open",
            id: "acc-close-others",
            className: "acc-close-others",
            checked: true,
          },
        ],
      },
        ...
        fields: [
          {
            ...
            className: "acc-style",
            options: [
              { value: "1", label: "Style 1", selected: true },
          ...
          },
          {
            ...
            className: "acc-icon",
            options: [
              { value: "plusminus", label: "Plus / Minus", selected: true },
              { value: "arrow-up-down", label: "Arrow Up / Down" },
    ...
    generatorCssDownload: {
      href: "",
      fileName: "accordion-generator.css",
  ...
  preview: {
    ...
    accordion: {
      classList: [
        "rlab-acc-main",
        "rlab-acc-style1",
        "rlab-acc-icon-plusminus",
      ],
      innerClass: "rlab-acc-inner",
      row: {
        id: "accPreviewRow",
        classList: ["rlab-acc-col-wrap", "rdc-d-flex"],
      },
    },
  },
  tutorial: {
...
function renderField(field) {
  return `
    <div class="rdc-d-flex">
      <label class="rdc-w-half"${field.id ? ` for="${field.id}"` : ""}>${field.label}</label>
...
function renderFieldControl(field) {
  if (field.type === "checkbox") {
    return `<input type="checkbox"${field.id ? ` id="${field.id}"` : ""} class="${field.className} rdcl-gen--cols-field"${field.checked ? " checked" : ""} />`;
  }

  return `
    <select${field.id ? ` id="${field.id}"` : ""} class="${field.className} rdcl-gen--cols-field rdc-w-half">
...
function renderPreview(content) {
  return `
    <div class="${content.wrapperClass}">
      <div class="${content.accordion.classList.join(" ")}">
        <div class="${content.accordion.innerClass}">
          <div class="${content.accordion.row.classList.join(" ")}" id="${content.accordion.row.id}"></div>
        </div>
      </div>
    </div>
  `;

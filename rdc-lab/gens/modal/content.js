const generatorContent = {
  leftView: {
    ...
    description:
      "Create responsive modal HTML/CSS/JS for offers, forms, notices, guides, and Shopify content. Control placement, alignment, radius, spacing, and trigger visibility, then refine with AI prompts.",
    callouts: [
      {
    ...
    useCases: [
      "Display newsletter signup, lead capture, or offer modals",
      "Show age verification, notices, or consent messages",
      "Create promotion, discount, or campaign popups",
      "Open product size guides, specs, or care details",
      "Display additional product or policy information",
      "Show forms or quick actions without leaving the page",
    ],
    useCta: {
...
`,
      text: "Build custom modals without relying on third-party apps.",
    },
    output: {
      element: "pre",
      codeId: "modalOutput",
        ...
        fields: [
          {
            type: "text",
            label: "Desktop",
            id: "modal-spacing-desktop",
            placeholder: "0",
          },
          {
            type: "text",
            label: "Tablet",
            id: "modal-spacing-tablet",
            placeholder: "20px",
          },
          {
            type: "text",
            label: "Mobile",
            id: "modal-spacing-mobile",
            placeholder: "20px",
          },
        ],
      },
...
`,
  ...
  preview: {
    ...
    stageId: "modalPreviewStage",
    mainClass: "rlab-modal-main",
    overlayClass: "rlab-modal-overlay",
    dialogClass: "rlab-modal-dialog",
    innerClass: "rlab-modal-inner",
    closeClass: "rlab-modal-close",
    titleClass: "rlab-modal-title",
    textClass: "rlab-modal-text",
    title: "Modal Title",
    text: "Add your modal content here.",
  },
};

initModalGenerator(generatorContent);

function initModalGenerator(content) {
  const init = () => {
    const hasTemplate =

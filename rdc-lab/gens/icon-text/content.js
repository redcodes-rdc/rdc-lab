const generatorContent = {
  leftView: {
    ...
    description:
      "Generate responsive icon-with-text HTML/CSS sections for benefits, trust signals, feature highlights, and store policies. Adjust layout and device behavior, then refine the design with AI prompts.",
    callouts: [
      {
    ...
    useCases: [
      "Highlight product benefits with icons and short copy.",
      "Create trust signal rows for shipping, returns, or support.",
      "Show feature highlights in responsive columns.",
      "Add store policy summaries to product or cart pages.",
      "Build service, value, or process highlight blocks.",
      "Create reusable icon text sections for Shopify themes.",
    ],
    useCta: {
...
`,
  ...
  settings: {
        ...
        fields: [
          {
            ...
            id: "iwt-layout",
            options: [
              { value: "top", label: "Image on Top", selected: true },
        ...
        fields: [
          {
            type: "select",
            label: "Desktop",
            id: "iwt-desktop-behavior",
            options: [
              { value: "wrap", label: "Wrap", selected: true },
    ...
    generatorCssDownload: {
      href: "",
      fileName: "icon-with-text-generator.css",
...
`,
  ...
  preview: {
    ...
    stageId: "iwtPreviewStage",
    mainClass: "rlab-iwt-main",
    innerClass: "rlab-iwt-inner",
    rowClass: "rlab-iwt-row",
    itemClass: "rlab-iwt-item",
    itemInnerClass: "rlab-iwt-item-inner",
    iconClass: "rlab-iwt-icon",
    contentClass: "rlab-iwt-content",
    titleClass: "rlab-iwt-title",
    textClass: "rlab-iwt-text",
    sampleItems: [
      {
        icon: "/gens/icon-text/assets/rdclab-icontext-ph-icon.svg",
        title: "Feature Title",
        text: "Short supporting text goes here.",
      },
      {
        icon: "/gens/icon-text/assets/rdclab-icontext-ph-icon.svg",
        title: "Feature Title",
...
initIconWithTextGenerator(generatorContent);

function initIconWithTextGenerator(content) {
  const init = () => {
    const hasTemplate =
...
function renderFieldControl(field) {
  if (field.type === "text") {
    return `<input type="text" id="${field.id}" class="rdcl-gen--cols-field rdc-w-half" placeholder="${field.placeholder}" />`;
  }

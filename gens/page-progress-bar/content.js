const generatorContent = {
  leftView: {
    ...
    description:
      "Create a lightweight scroll progress bar with HTML/CSS/JS for articles, tutorials, setup flows, and long pages. Copy production-ready code, customize it, and refine behavior with AI prompts.",
    callouts: [
      {
    ...
    useCases: [
      "Add a reading progress bar to blog posts and articles",
      "Show progress on tutorials, guides, and resource pages",
      "Track progress through setup or registration content",
      "Display progress through account setup pages",
      "Support progress cues for long forms or flows",
      "Add scroll feedback to long product or landing pages",
    ],
    useCta: {
...
`,
  ...
  settings: {
    ...
    generatorCssDownload: {
      href: "",
      fileName: "reading-progress-bar-generator.css",
...
`,
  ...
  preview: {
    ...
    mainClass: "rlab-rp-main",
    barClass: "rlab-rp-bar",
    fillClass: "rlab-rp-bar-fill",
    fillId: "rpBarFill",
  },
};

initReadingProgressGenerator(generatorContent);

function initReadingProgressGenerator(content) {
  const init = () => {
    const hasTemplate =
    ...
    bindReadingProgressGenerator(content);
  };
...
function insertPreview(content) {
  ...
  container.innerHTML = `<div class="${content.wrapperClass}"></div>`;
}
...
function buildReadingProgressPreview(content) {
  return `<div class="${content.mainClass}">
  <div class="${content.barClass}">
    <div class="${content.fillClass}" id="${content.fillId}"></div>
  </div>
</div>`;
}

function updateReadingProgressPreviewStyles() {
  let style = document.querySelector("#rp-preview-style");

  if (!style) {
    style = document.createElement("style");
    style.id = "rp-preview-style";

const generatorContent = {
  leftView: {
    ...
    description:
      "Generate responsive tab HTML/CSS/JS for product information, FAQs, specifications, plans, and landing page content. Customize layout and mobile behavior, then refine with AI prompts.",
    callouts: [
      {
    ...
    useCases: [
      "Organize product descriptions, specs, and policies into tabs",
      "Separate shipping, returns, care, and FAQ content",
      "Build tabbed feature and specification sections",
      "Create pricing, plan, or comparison tabs",
      "Display multiple content sections without clutter",
      "Create tabbed content blocks for landing pages",
    ],
    useCta: {
...
`,
      text: "Display more information without cluttering your page layout.",
    },
    output: {
      element: "pre",
      codeId: "tabsOutput",
        ...
        fields: [
          {
            label: "Tab Count",
            id: "tabs-count",
            options: createOptions(["2", "3", "4", "5", "6"], "4"),
          },
        ],
      },
      {
        ...
        fields: [
          {
            label: "Desktop",
            id: "tabs-desktop-layout",
            options: createLayoutOptions(),
          },
          {
            label: "Tablet",
            id: "tabs-tablet-layout",
            options: createLayoutOptions(),
          },
          {
            label: "Mobile",
            id: "tabs-mobile-layout",
            options: createLayoutOptions(),
          },
        ],
      },
...
`,
  ...
  preview: {
    ...
    stageId: "tabsPreviewStage",
  },
};

initTabsGenerator(generatorContent);

function initTabsGenerator(content) {
  const init = () => {
    const hasTemplate =
...
function renderField(field) {
  return `
    <div class="rdc-d-flex">
      ...
      <select id="${field.id}" class="rdcl-gen--cols-field rdc-w-half">

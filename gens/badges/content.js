const generatorContent = {
  leftView: {
    title: "Product Badge Generator",
    description:
      "Create lightweight product badge HTML/CSS for sales, new arrivals, inventory notes, and campaign labels. Adjust text, colors, radius, and position, then refine the style with AI prompts.",
    callouts: [
      {
        icon: `<img src="/assets/icons/overline-co-icon.svg" alt="">`,
        text: "Lightweight CSS",
      },
      {
        icon: `<img src="/assets/icons/overline-co-icon.svg" alt="">`,
        text: "Shopify Ready",
    ...
    useCases: [
      "Highlight best-selling products and featured picks",
      "Show sale, discount, and campaign offers",
      "Mark new arrivals or limited edition products",
      "Promote limited stock or low inventory items",
      "Call out product features, materials, or benefits",
      "Add trust labels like handmade, vegan, or warranty",
    ],
    useCta: {
...
`,
      text: "Quickly create product badges that highlight offers, features, and best sellers.",
    },
    output: {
      element: "pre",
      codeId: "pbadgeOutput",
  ...
  settings: {
        ...
        fields: [
          {
            ...
            label: "Badge Text",
            id: "pbadge-text",
            className: "rdcl-gen--cols-field rdc-w-half",
            placeholder: "SALE / BEST SELLER / SAVE $15",
            value: "SALE",
          },
          {
            type: "text",
          ...
          },
          {
            ...
            options: [
              ...
              { value: "top-left", label: "Upper Left", selected: true },
    ...
    generatorCssDownload: {
      href: "",
      fileName: "product-badge-generator.css",
...
`,
  ...
  preview: {
    ...
    stageId: "pbadgePreviewStage",
    badge: {
      className: "rlab-pbadge-badge",
      defaultPosition: "top-left",
      text: "SALE",
    },
    product: {
      image: {
        src: "https://elements-resized.envatousercontent.com/envato-dam-assets-production/EVA/TRX/eb/a5/d7/9e/a8/v1_E10/E105X7LM.jpg?w=1600&cf_fit=scale-down&q=85&format=auto&s=d4c88dde67a259dce73f84d0b576a928cfe82a6890e01575824ff83d4770c2f1",
        alt: "Black and white sneaker product preview",
      },
      title: "AeroStride Sneakers",
      description:
        "Lightweight and breathable sneakers designed for all-day comfort and style.",
      price: "$79.99",
      comparePrice: "$109.99",
      discount: "27% OFF",
      rating: "4.5",
      ...
      galleryCount: "1 / 4",
      features: [
        { icon: "leaf", label: "Lightweight Design" },
        { icon: "cloud", label: "Breathable Material" },
        { icon: "sole", label: "Cushioned Sole" },
        { icon: "run", label: "All-Day Comfort" },
      ],
    },
  },
};

initProductBadgeGenerator(generatorContent);

function initProductBadgeGenerator(content) {
  const init = () => {
    const hasTemplate =
...
function renderFieldControl(field) {
  ...
  return `<input type="${field.type}" id="${field.id}" class="${field.className}" placeholder="${field.placeholder || ""}" value="${field.value || ""}" />`;
}
...
function renderPreview(content) {
  ...
  return `
    <div class="${content.wrapperClass}" id="${content.stageId}">
      <div class="rlab-pbadge-preview-shell rdc-d-flex rdc-jc-cen">
        <div class="rlab-pbadge-card">
          <div class="rlab-pbadge-img-wrap">
            <div class="${badge.className} rlab-pbadge-pos-${badge.defaultPosition}">${badge.text}</div>

            <img src="${product.image.src}" class="rlab-pbadge-img" alt="${product.image.alt}" />
            <span class="rlab-pbadge-count">${product.galleryCount}</span>
          </div>

          <div class="rlab-pbadge-content">
            <div class="rlab-pbadge-meta rdc-d-flex rdc-ai-cen rdc-jc-spb">
              <span class="rlab-pbadge-stock"><span></span>${product.stock}</span>
              <span class="rlab-pbadge-rating"><span>&#9733;&#9733;&#9733;&#9733;&#9734;</span> <small>(${product.reviews})</small></span>
            </div>

            <h3 class="rlab-pbadge-title">${product.title}</h3>
            <p class="rlab-pbadge-desc">${product.description}</p>


            <div class="rlab-pbadge-buy-row rdc-d-flex rdc-ai-cen">
              <div class="rlab-pbadge-price-wrap rdc-d-flex rdc-ai-cen">
                <span class="rlab-pbadge-price">${product.price}</span>
                <span class="rlab-pbadge-compare">${product.comparePrice}</span>
                <span class="rlab-pbadge-discount">${product.discount}</span>
              </div>


            </div>

            <button class="rlab-pbadge-cart" type="button">Add to Cart</button>
          </div>
        </div>
      </div>
    </div>
